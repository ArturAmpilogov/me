...
export const portfolio: IPortfolio[] = [
  ...
  {
    name: "Socionom",
    description: "The social network for education. The work is done as the CTO, including architecture, DevOps, and microservices creation. The team used Vue.JS, Node.JS, MongoDB, Postgres, and Redis.",
